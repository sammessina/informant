...
class WeatherModule(Module):
    def __init__(self):
        ...
        self.temp_label = render.OutlinedTextImg(color="#ffffff", outercolor="black", size=60)
        self.weather_label = render.OutlinedTextImg(color="#ffffff", outercolor="black", size=50)
        self.img = None
        self.temp_f = 999
        self._i = 0
        self.get_weather()
